		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comemployeeemployeeapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comemployeeemployeeapp-display": {
								"semanticObject": "comemployeeemployeeapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.employee.employeeapp",
									"url": sap.ui.require.toUrl("com/employee/employeeapp")
								}
							}
						}
					}
